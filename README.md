...
[![Xcode](https://img.shields.io/badge/Xcode-16.2+-purple.svg)](https://developer.apple.com/xcode/)
...
- **库存总览** — 瀑布流展示、位置/类型筛选、统计卡片、下拉刷新
- **服装入库** — 拍照/选图上传七牛云、条码自动生成（Code128）、动态表单
- **服装详情** — 完整信息展示、闲鱼链接管理、标记售出/退货
- **统计分析** — 销售总额/总量、TOP3 品类排行、位置库存分布、条码搜索
- **蓝牙打印** — BLE 设备扫描连接、多协议自动切换（HM-T/ESC-POS/TSPL）
